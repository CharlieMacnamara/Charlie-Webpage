      ...
      <div className="space-y-20">
        <PortfolioSection title="Technical Blog Posts">
          <ProjectCard
            ...
            description="Technical guide on integrating AI-powered face detection in CDN infrastructure."
            cta="Read Article"
          />
          <ProjectCard
            href="https://transloadit.com/blog/2022/05/geolocation-watermark/"
            title="Building a Geolocation Image Watermarker"
            description="Tutorial on combining APIs to create a location-aware image processing system."
            cta="View Tutorial"
          />
          <ProjectCard
            href="https://configcat.com/blog/2020/07/08/introduction-to-configcat-api/"
            title="Deep Dive: ConfigCat Public Management API"
            description="Comprehensive guide to the ConfigCat Management API with implementation examples."
            cta="Read Guide"
          />
          <ProjectCard
            href="https://transloadit.com/demos/video-encoding/encode-blurout-effect/"
            title="Advanced Video Processing with FFmpeg"
            description="Technical guide on implementing complex video effects using FFmpeg."
            cta="View Demo"
          />
        </PortfolioSection>
        ...
        <PortfolioSection title="Technical Content">
          ...
          <ProjectCard
            ...
            description="Concise announcement of new Wisej.NET features for developers."
            cta="View Example"
          />
        </PortfolioSection>
      </div>
