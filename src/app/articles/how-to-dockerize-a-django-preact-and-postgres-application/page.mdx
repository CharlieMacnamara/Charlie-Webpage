...
export const article = {
  ...
  description:
    'Attempting to simplify the complexities of making these technologies coexist. This journey was documented to help others avoid the difficulties I encountered. This blog covers the prerequisites, installing Django and Preact, Docker containerisation, and configuring Docker Compose.',
}
