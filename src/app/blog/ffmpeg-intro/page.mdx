...
export const article = {
  ...
  description:
    'Master FFmpeg: Install the tool, execute your first command in minutes, and learn 7 practical techniques for video manipulation. Includes real-world examples from my work at Transloadit.',
}
...
```
<DynamicPlayer mediaUrl="/videos/watermarked.mp4" mediaType="video" playing="false"/>
...
```
<DynamicPlayer mediaUrl="/videos/silent.mp4" mediaType="video" />
...
<DynamicPlayer mediaUrl="/videos/sample.mp4" mediaType="video" />
...
<DynamicPlayer mediaUrl="/videos/segment.mp4" mediaType="video" />
...
<DynamicPlayer mediaUrl="/videos/fast.mp4" mediaType="video" />
...
<DynamicPlayer mediaUrl="/videos/batchoutput_segment.mkv" mediaType="video" />
